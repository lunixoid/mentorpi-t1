...
def generate_launch_description():
    ...
    if compiled == "True":
        hiwonder_description_package_path = get_package_share_directory("hiwonder_description")
        ...
        hiwonder_description_package_path = "/home/ubuntu/ros2_ws/src/hiwonder_simulations/hiwonder_description"
        robot_controller_package_path = "/home/ubuntu/ros2_ws/src/hiwonder_driver/ros_robot_controller"
        hiwonder_controller_package_path = "/home/ubuntu/ros2_ws/src/hiwonder_driver/hiwonder_controller"

    robot_description_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [os.path.join(hiwonder_description_package_path, "launch/robot_description.launch.py")]
        ),
        launch_arguments={
    ...
    odom_publisher_node = Node(
        ...
        output="screen",
        parameters=[
            os.path.join(hiwonder_controller_package_path, "config/calibrate_params.yaml"),
            {
